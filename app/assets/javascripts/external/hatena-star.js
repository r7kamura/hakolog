...
//      new Ten.Observer(this.img,'onmouseout',this,'hideSelectedColor');
    ...
    addStar: function(e) {
        ...
        var uri = Hatena.Star.BaseURL + this.constructor.AddStarPath + '?uri=' + encodeURIComponent(this.entry.uri) +
...
Hatena.Star.Pallet = new Ten.Class({
    ...
    getPalletFrameURL: function () {
        return Hatena.Star.BaseURL + this.constructor.PALLET_PATH + '?uri=' + encodeURIComponent(this.addButton.entry.uri) + '&location=' + encodeURIComponent(document.location.href);
    },
...
Hatena.Star.AddButton.SmartPhone = new Ten.Class({
    ...
    getPalletFrameURL: function () {
        return Hatena.Star.BaseURL + this.constructor.PALLET_PATH + '?uri=' + encodeURIComponent(this.addButton.entry.uri) + '&location=' + encodeURIComponent(document.location.href) + '&colorscheme=' + this.constructor.getColorScheme();
    }
});
...
Hatena.Star.Pallet.SmartPhone = new Ten.Class({
    ...
    COLOR_SCHEME_DEFINITIONS: {
        dark: {
            ...
            getCloseButtonImage: function () { return Hatena.Star.BaseURL + 'images/close_wh.png' }
        },
        light: {
            ...
            getCloseButtonImage: function () { return Hatena.Star.BaseURL + 'images/close.gif' }
        }
    },
        ...
        this.container.innerHTML =
            '<div id="hatena-star-pallet-container">' + 
                ...
                '<div class="pallet-container">' +
                    '<div class="pallet">' +
                        '<a href="#"><img src="' + Hatena.Star.BaseURL + '/images/spacer.gif" id="hatena-star-yellow" class="star yellow post" alt="Add Yellow Star" title="Add Yellow Star" /></a>' + 
                ...
                '</div>' + 
                '<a href="' + Hatena.Star.PortalURL.replace(/http/, 'https') + '/shop/star?location=' + encodeURIComponent(location.href) + '" id="buy" target="' + (Ten.Browser.isDSi ? '_top' : '_blank' ) + '"><img src="' + Hatena.Star.BaseURL + 'images/buy_star_cart_purple.gif" class="cart">' + Hatena.Star.Text.for_colorstar_shop + '</a>' +
            '</div>' + 
            '<style type="text/css">' +
                ...
                '#hatena-star-pallet-container #hatena-star-yellow {' +
                    'background: url(' + Hatena.Star.BaseURL + (Hatena.Star.Pallet.SmartPhone.ColorScheme == 'dark' ? '/images/add_star_for_smartphone_bk.gif' : '/images/add_star_for_smartphone_wh.gif') + ') 0 0;' +
                    'width: 39px;' +
                    'height: 39px;' +
                    'border: 0;' +
                '}' +
                '#hatena-star-pallet-container a.active #hatena-star-yellow {' +
                    'background: url(' + Hatena.Star.BaseURL + (Hatena.Star.Pallet.SmartPhone.ColorScheme == 'dark' ? '/images/add_star_for_smartphone_bk.gif' : '/images/add_star_for_smartphone_wh.gif') + ') 0 39px;' +
                    'width: 39px;' +
                    'height: 39px;' +
                    'border: 0;' +
                '}' +
...
//    ImgSrc: Hatena.Star.BaseURL + 'images/star.gif',
    ...
    getAnchor: function () {
        if (Hatena.Star.isTouchUA) {
            ...
            return Hatena.Star.BaseURL + '/mobile/entry?uri=' + encodeURIComponent(this.entry.uri);
        } else {
...
Hatena.LoginWindow = new Ten.Class({
    ...
    hide: function () {
        var script = document.createElement('script');
        script.src = Hatena.Star.BaseURL + 'js/HatenaStar.js';
...
try {
(function () {
    var valentine_end = new Date('2011/02/15 00:00:00');
    var now = new Date();
    if (now < valentine_end) {
        Hatena.Star.Star.ColorPallet.yellow.ImgSrc = Hatena.Star.BaseURL + 'images/valentine-star.gif';
        Hatena.Star.Star.ColorPallet.green.ImgSrc  = Hatena.Star.BaseURL + 'images/valentine-star-green.gif';
        Hatena.Star.Star.ColorPallet.red.ImgSrc    = Hatena.Star.BaseURL + 'images/valentine-star-red.gif';
        Hatena.Star.Star.ColorPallet.blue.ImgSrc   = Hatena.Star.BaseURL + 'images/valentine-star-blue.gif';
        Hatena.Star.Star.ColorPallet.purple.ImgSrc = Hatena.Star.BaseURL + 'images/valentine-star-purple.gif';
        Hatena.Star.Star.ColorPallet.temp.ImgSrc   = Hatena.Star.BaseURL + 'images/valentine-star-temp.gif';
    }
})()
} catch (e) {}
...
Hatena.Star.Token = '3af64c1e51010129aa89065ea7af51ea984aa82a';
Hatena.Star.SiteConfig = {
  entryNodes: {
    'article': {
      uri: 'h1 a',
